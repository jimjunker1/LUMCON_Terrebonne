...
Anthropogenic activities continue to exert long-term, varied, and increasing pressures on marine ecosystems causing alterations to biological diversity on broad and local scales. Shifts in biodiversity are variable, nuanced and difficult to predict, yet, understanding how communities change through time is crucial for predicting current and future changes to biological systems and the services they provide. We document a decade of biodiversity change in the nekton community of a shallow-estuary...
...
mth_group_stats %>%
  ...
  annotate('text', label = "A", x = as.Date("2009-01-30"), y = 11, family ='serif', size = 6, hjust = 0)+
...
trawl_mth_turnover %>%
  ...
  annotate('text', label = "B", x = as.Date("2009-01-30"), y = 1, family = 'serif', vjust = 1, size = 6, hjust = 0)+
...
hill_time_df %>%
  ...
  annotate('text', label = 'A', x = as.Date("2009-01-01"), y = Inf, size = 6, hjust = 0, vjust = 1, family ='serif')+
  theme(axis.title.x = element_blank(),
...
qD_coefs_df %>% 
  ...
  annotate('text', label = 'B', x = -2.5, y = 0, hjust = 0, vjust = 1, size = 6, family = 'serif')+
  theme_tufte()+
...
```{r spp contributions, fig.height=8, fig.width=3.5, dpi=450, fig.cap="Figure 5."}
...
q0.1_dis_plot = TB_trawl_q0.1_dis %>%
  ...
  annotate("text", label = expression(italic(""^q*"D = 0.1")), x = Inf, y = Inf, vjust = 1, hjust = 1, size = 6, family = "serif")+
...
ggplot()+
  ...
  theme_tufte()+
  geom_rangeframe(sides = "bl", color = "black")+
  annotate("text", label = expression(italic(""^q*"D = 0.5")), x = Inf, y = Inf, vjust = 1, hjust = 1, size = 6, family = "serif")+
  theme(axis.text.x = element_blank(),
        axis.title = element_blank());
...
ggplot()+
  ...
  theme_tufte()+
  geom_rangeframe(sides = "bl", color = "black")+
  annotate("text", label = expression(italic(""^q*"D = 1")), x = Inf, y = Inf, vjust = 1, hjust = 1, size = 6, family = "serif")+
  theme(axis.text.x = element_blank(),
        axis.title = element_blank());
...
ggplot()+
  ...
  theme_tufte()+
  geom_rangeframe(sides = "bl", color = "black")+
  annotate("text", label = expression(italic(""^q*"D = 2")), x = Inf, y = Inf, vjust = 1, hjust = 1, size = 6, family = "serif")+
...
TB_q2_spp_plot = TB_q2_spp_df %>%
  ...
  annotate('text', label = expression(italic(""^q*"D = 2")), x = as.Date("2019-12-31"), y = Inf, vjust = 1, hjust = 1, size = 6, family = 'serif')+
...
TB_q1_spp_plot = TB_q1_spp_df %>%
  ...
  geom_rangeframe(data = TB_q1_spp_df, aes(x = Date, y = scale_n),
                  sides = 'bl', color = 'black', inherit.aes = FALSE)+
  annotate('text', label = expression(italic(""^q*"D = 1")), x = as.Date("2019-12-31"), y = Inf, vjust = 1, hjust = 1, size = 6, family = 'serif')+
  theme(legend.title = element_blank(),
        axis.title.x = element_blank(),
        legend.position = c(0,1),
        legend.justification = c(0,1),
...
TB_q0.5_spp_plot = TB_q0.5_spp_df %>%
  ...
  geom_rangeframe(data = TB_q0.5_spp_df, aes(x = Date, y = scale_n),
                  sides = 'bl', color = 'black', inherit.aes = FALSE)+
  annotate('text', label = expression(italic(""^q*"D = 0.5")), x = as.Date("2019-12-31"), y = Inf, vjust = 1, hjust = 1, size = 6, family = 'serif')+
  theme(legend.title = element_blank(),
        axis.title.x = element_blank(),
        legend.position = c(0,1),
        legend.justification = c(0,1),
...
TB_q0.1_spp_plot = TB_q0.1_spp_df %>%
  ...
  geom_rangeframe(data = TB_q0.1_spp_df, aes(x = Date, y = scale_n),
                  sides = 'bl', color = 'black', inherit.aes = FALSE)+
  annotate('text', label = expression(italic(""^q*"D = 0.1")), x = as.Date("2019-12-31"), y = Inf, vjust = 1, hjust = 1, size = 6, family = 'serif')+
  theme(legend.title = element_blank(),
        axis.title.x = element_blank(),
        legend.position = c(0,1),
        legend.justification = c(0,1),
...
grid.draw(rbind(ggplotGrob(TB_q0.5_spp_plot), ggplotGrob(TB_q2_spp_plot), size = 'last'))

```

```{r trawl contributions,echo=FALSE, warning=FALSE, message=FALSE, fig.cap="Figure 6. The contribution of individual trawl-dates to dissimilarity of the entire timeseries for diversity order q = 0.5 (top), q = 1 (middle), and q = 2 (bottom)." }
...
TB_trawl_q0_dis2 %>%
  ...
  theme_tufte()+
  geom_rangeframe(sides = "lb", color = "black")+
  annotate('text', label = expression(italic(''^q*"D = 0")), x = as.Date("2009-01-01"), y = Inf, size = 6, family = 'serif')+
...
TB_trawl_q0.1_dis2 %>%
  ...
  theme_tufte()+
  geom_rangeframe(sides = "lb", color = "black")+
  annotate('text', label = expression(italic(''^q*"D = 0.1")), x = as.Date("2009-01-01"), y = Inf, size = 6, family = 'serif')+
  theme(axis.title = element_blank(),
...
TB_trawl_q0.5_dis2 %>%
  ...
  theme_tufte()+
  geom_rangeframe(sides = "lb", color = "black")+
  annotate('text', label = expression(italic(''^q*"D = 0.5")), x = as.Date("2019-12-31"), y = Inf, size = 6, family = 'serif', vjust = 1, hjust =1)+
  theme(axis.title = element_blank(),
        axis.text.x = element_blank())-> TB_q0.5_dis2_plot
...
TB_trawl_q1_dis2 %>%
  ...
  theme_tufte()+
  geom_rangeframe(sides = "lb", color = "black")+
  annotate('text', label = expression(italic(''^q*"D = 1")), x = as.Date("2019-12-31"), y = Inf, size = 6, family = 'serif', vjust = 1, hjust = 1)+
  theme(axis.title = element_blank(),
...
TB_trawl_q2_dis2 %>%
  ...
  theme_tufte()+
  geom_rangeframe(sides = "lb", color = "black")+
  annotate('text', label = expression(italic(''^q*"D = 2")), x = as.Date("2019-12-31"), y = Inf, size = 6, family = 'serif', vjust = 1, hjust = 1)+
  theme(axis.title= element_blank()) -> TB_q2_dis2_plot
  
grid.draw(rbind(ggplotGrob(TB_q0.5_dis2_plot),
...
temperature_series %>%
  ...
  scale_x_date(date_breaks = "year", limits = c(as.Date("2009-01-01"),as.Date("2019-12-31")),
               date_labels = "%Y",expand = c(0.01,0.01))+
  annotate('text', label = 'A', x = as.Date("2009-01-01"), y = Inf, vjust = 1, hjust = 0, size = 6, family = 'serif')+
  theme_tufte()+
  geom_rangeframe(sides = "bl", color = "black")+
  theme(axis.title.x = element_blank(),
        axis.text.x = element_blank())
...
salinity_series %>%
  ...
  scale_y_continuous(name = "Salinity (PSU)", limits = c(0,NA), expand =c(0.01,0.01))+
    annotate('text', label = 'B', x = as.Date("2009-01-01"), y = Inf, vjust = 1, hjust = 0, size = 6, family = 'serif')+
  theme_tufte()+
  geom_rangeframe(sides = "bl", color = "black")+
  theme(axis.title.x = element_blank())
