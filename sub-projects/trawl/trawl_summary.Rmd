...
knit: (function(inputFile, encoding) { 
      out_dir <- here::here('sub-projects/trawl/docs');
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path(out_dir, 'trawl_summary.html')) })
output: 
  html_document:
      keep_md: true
      toc: true
...
<!-- #  -->
<!-- # `r knitr::include_graphics(here::here("sub-projects/trawl/docs/figures/env_facet_plot.png"))` -->
...
# beta_dates <- sapply(as.numeric(names(beta_lists)), function(x) as.Date(x, origin = as.Date("2007-01-01"))) 
